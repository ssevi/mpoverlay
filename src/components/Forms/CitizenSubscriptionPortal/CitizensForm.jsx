    ...
    return (
        <>
            ...
            <Grid container spacing={1} >
                ...
                <Grid item xs={12} md={4}>
                    {error.firstname && <FormHelperText style={{ color: "#ff1100" }}>Please enter the First Name </FormHelperText>}
                ...
                <Grid item xs={12} md={4}>
                    {error.lastname && <FormHelperText style={{ color: "#ff1100" }}>Please enter the Last Name </FormHelperText>}
                ...
                <Grid item xs={12} md={4}>
                    {error.dateofbirth && <FormHelperText style={{ color: "#ff1100" }}>Please enter the Date of Birth </FormHelperText>}
                ...
                <Grid item xs={12} md={4}>
                    {error.phonenumber && <FormHelperText style={{ color: "#ff1100" }}>Please enter the Phone Number </FormHelperText>}
                ...
                <Grid item xs={12} md={6}>
                    {error.whatsappnumber && <FormHelperText style={{ color: "#ff1100" }}>Please enter the WhatsApp Number </FormHelperText>}
                ...
                <Grid item xs={12} md={4}>
                    {error.email && <FormHelperText style={{ color: "#ff1100" }}>Please enter the Email </FormHelperText>}
                    <TextField label="Email" type="email" fullWidth variant="outlined" size="small" value={data.email} onChange={(e) => handleChange(e, 'email')} />
                </Grid>

                <Grid item xs={12} md={4}>
                    {error.presentaddress && <FormHelperText style={{ color: "#ff1100" }}>Please enter the Present Address </FormHelperText>}
                ...
                <Grid item xs={12} md={4}>
                    {error.communicationaddress && <FormHelperText style={{ color: "#ff1100" }}>Please enter the Communication Address </FormHelperText>}
                ...
                <Grid item xs={12} md={4}>
                    {error.dispatchaddress && <FormHelperText style={{ color: "#ff1100" }}>Please enter the Dispatch Address </FormHelperText>}
