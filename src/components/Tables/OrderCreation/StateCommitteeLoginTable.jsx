...
export default function StateCommitteeLoginTable() {
    const columns = [
        ...
        <Box sx={{ display: "flex", flexDirection: "column" }}>
            ...
            <Grid container spacing={1} justifyContent="space-evenly">
                ...
                <Grid item xs={12} md={3} style={{ display: "flex", alignItems: "center", justifyContent: "center" }}>
                    <Button variant="contained" style={{ backgroundColor: "#3b4a54", textTransform: "none", width: "240px", height: "40px", marginLeft: 10 }} startIcon={<PrintIcon />}>
